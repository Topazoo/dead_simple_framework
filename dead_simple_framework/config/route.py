...
class Route(Config):
    ...
    def __init__(self, url:str, handler, name:str=None, defaults:dict=None, collection:str=None, database:str=None):
        ...
        Args:
            ...
            handler (RouteHandler): A `RouteHandler` class specifying the logic for this route
